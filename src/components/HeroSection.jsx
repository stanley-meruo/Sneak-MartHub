...
const HeroSection = () => {
  ...
  return (
    <main className="font-parkisans bg-gradient-to-b from-primary via-teal-50 to-secondary relative w-full grid text-darkBlue py-4 md:flex md:items-center md:pb-20 lg:pt-12 lg:px-4 xl:px-8 xl:gap-6 xxl:px-16 xxl:gap-10">
      <motion.div
